                ...
                <div className="d-table-cell">
                  <div className="container">
                    ...
                    <div className="banner-image">
                      ...
                      <img
                        src="assets/img/home-one/image-1.png"
                ...
                <div className="d-table-cell">
                  <div className="container">
                    ...
                    <div className="banner-image">
                      <img src="assets/img/home-one/shape.png" alt="image" />
                      <img
                        src="assets/img/home-one/image-2.png"
                        className="banner-img"
                        alt="image"
                      />
                    </div>
                ...
                <div className="d-table-cell">
                  <div className="container">
                    ...
                    <div className="banner-image">
                      <img src="assets/img/home-one/shape.png" alt="image" />
                      <img
                        src="assets/img/home-one/image-3.png"
                        className="banner-img"
                        alt="image"
                      />
                    </div>
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6">
                ...
                <div className="skill-bar" data-percentage="45%">
                  <p className="progress-title-holder">
                ...
                <div className="skill-bar" data-percentage="70%">
                  <p className="progress-title-holder">
